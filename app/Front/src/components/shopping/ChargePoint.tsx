...
const ChargePoint: React.FC = () => {
  ...
  return (
    <div>
      <div>
        <img src={Point} alt="PointCharge" />
        <span>250P</span>
        <button onClick={() => handleCharge(250)}>₩2500</button>
      </div>
      <div>
        <img src={Point} alt="PointCharge" />
        <span>550P</span>
        <button onClick={() => handleCharge(550)}>₩5000</button>
      </div>
      <div>
        <img src={Point} alt="PointCharge" />
        <span>1100P</span>
        <button onClick={() => handleCharge(1100)}>₩10000</button>
      </div>
      <StyledModal
        isOpen={modalOpen}
